...
```{r}
mechacar_table <- read.csv(file='C:/Users/Owner/Documents/Bootcamp/AllHW/MechaCar_Statistical_Analysis/MechaCar_mpg.csv')
```
...
### Import Data and Create Table
```{r}
suspension_table <- read.csv(file='C:/Users/Owner/Documents/Bootcamp/AllHW/MechaCar_Statistical_Analysis/Suspension_Coil.csv', check.names = F, stringsAsFactors = F)
```
